...
<div id="elasticsearch-filters-active">
    <h3>Applied Filters (<a style="font-size: 80%"
            href="<?php echo get_view()->url('/elasticsearch').'?q='.urlencode($query['q']); ?>">Reset</a>)</h3>
    <ul>
        ...
        <li>
            ...
            <a
                href="<?php echo get_view()->url('/elasticsearch') . '?' . Elasticsearch_Utils::removeFacetFromQuery($querystr, $facet_name); ?>">&#10006;</a>
        </li>
        <?php endforeach ?>
...
<div id="elasticsearch-filters">
    ...
    <ul>
        ...
        <li><a href="<?php echo $facet_url; ?>"><?php echo htmlspecialchars(__($agg_key)); ?></a>
            <?php echo " (".$agg['doc_count'].")"; ?></li>
        <?php endforeach; ?>
    </ul>
    <?php endif; ?>
    <?php endforeach; ?>
